...
<html lang="en">
  <head>
    ...
    <title>Simple PHP Framework Create New Account</title>
  ...
  <body class="text-center">
    ...
    <form method="post">
        ...
        <label>
            <input name="terms" type="checkbox" value="accept"> I accept the terms & conditions.
        </label>
        </div>
        <button class="w-100 btn btn-lg btn-primary" type="submit">Create</button>
        <p>Already a member? <a class="py-1 px-0" href="<?=ROOT?>/login">Sign in</a></p>
